            ...
            setChatButtons([
              {
                ...
                handler: async () => {
                  ...
                  await appendMessage(
                    "ai",
                    `Lunch & Arcade, Saturday @ 12, You & <a href="https://www.facebook.com/profile.php?id=61584120044411" target="_blank" style="color: #f3727e; font-weight: bold; text-decoration: underline;">Me</a> <- Click to find out :3`
                  );
                  await sleep(600);
